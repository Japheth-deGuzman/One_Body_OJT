...
class Hosanna extends StatefulWidget {
  const Hosanna({Key? key}) : super(key: key);

  @override
  State<Hosanna> createState() => _HosannaState();
}

class _HosannaState extends State<Hosanna> {
  final network1 =
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Onebody Admin on May 22, 2022 12:02PM',
