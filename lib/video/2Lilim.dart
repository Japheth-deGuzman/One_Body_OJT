...
class Lilim extends StatefulWidget {
  const Lilim({Key? key}) : super(key: key);

  @override
  State<Lilim> createState() => _LilimState();
}

class _LilimState extends State<Lilim> {
  final network1 =
...
by Victory Worship''', style: const TextStyle(fontSize: 17)),
                ),
                const SizedBox(
                  height: 40,
                ),
                ...
                morevid(controller3, 'Safe', 'Published by Onebody Admin',
                    'May 22, 2022 12:04PM', const Lilim()),
