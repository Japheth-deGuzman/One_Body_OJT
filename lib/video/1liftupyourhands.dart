...
class LiftUpYourHands extends StatefulWidget {
  const LiftUpYourHands({Key? key}) : super(key: key);

  @override
  State<LiftUpYourHands> createState() => _LiftUpYourHandsState();
}

class _LiftUpYourHandsState extends State<LiftUpYourHands> {
  final network1 =
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          'Onebody Admin on May 22, 2022 12:05PM',
                ...
                Container(
                  ...
                  alignment: Alignment.bottomLeft,
                  child: const Text(
                    'Author: Anthony Wilkins / Patrick Henderson \nMusic: Basil Valdez \nReleased:1994 \nCopyright: 1994',
                    style: TextStyle(fontSize: 17),
                  ),
                ),
                const SizedBox(
                ...
                morevid(controller2, 'Lilim', 'Published by Onebody Admin',
                    'May 22, 2022 12:05PM', const Lilim()),
                morevid(controller3, 'Safe', 'Published by Onebody Admin',
                    'May 22, 2022 12:04PM', const Safe()),
                morevid(controller4, 'Hosanna!', 'Published by Onebody Admin',
