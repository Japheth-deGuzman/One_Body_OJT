...
class Iliftmuhands extends StatefulWidget {
  const Iliftmuhands({Key? key}) : super(key: key);

  @override
  State<Iliftmuhands> createState() => _IliftmuhandsState();
}

class _IliftmuhandsState extends State<Iliftmuhands> {
  final network1 =
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  alignment: Alignment.bottomLeft,
                  child: const Text(
                    'Author: Christ Tomlin / Louie Giglio / Matt Maher \nMusic: Christ Tomlin \nReleased:2010\nCopyright: 2010',
                    style: TextStyle(fontSize: 17),
                  ),
                ),
                const SizedBox(
