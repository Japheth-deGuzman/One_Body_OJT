...
class Walangmahirapsayo extends StatefulWidget {
  const Walangmahirapsayo({Key? key}) : super(key: key);

  @override
  State<Walangmahirapsayo> createState() => _WalangmahirapsayoState();
}

class _WalangmahirapsayoState extends State<Walangmahirapsayo> {
  final network1 =
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Expanded(
                        child: Text(
                          'Onebody Admin on May 22, 2022 11:55AM',
                ...
                Container(
                  padding: const EdgeInsets.all(10),
                  child: const Text(
                    '''"27Ako si Yahweh, ang Diyos ng lahat ng tao; walang bagay na mahirap para sa akin."''',
