...
class WhatABeautifulName extends StatefulWidget {
  const WhatABeautifulName({Key? key}) : super(key: key);

  @override
  State<WhatABeautifulName> createState() => _WhatABeautifulNameState();
}

class _WhatABeautifulNameState extends State<WhatABeautifulName> {
  final network1 =
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Expanded(
                        child: Text(
                          'Admin on April 16, 2022 10:39AM',
                ...
                Container(
                  ...
                  alignment: Alignment.bottomLeft,
                  child: const Text(
                    'Author: Ben Fielding / Broke Ligertwood \nMusic: Hillsong Worship \nReleased:2017 \nCopyright: 2001',
                    style: TextStyle(fontSize: 17),
                  ),
                ),
                const SizedBox(
