...
class PraisetoGodforalivinghope extends StatefulWidget {
  const PraisetoGodforalivinghope({Key? key}) : super(key: key);

  @override
  State<PraisetoGodforalivinghope> createState() =>
      _PraisetoGodforalivinghopeState();
}

class _PraisetoGodforalivinghopeState extends State<PraisetoGodforalivinghope> {
  final network1 =
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      ...
                      const Expanded(
                        child: Text(
                          'OneBody Admin on December 18, 2021 12:43AM',
